...
(1, 'Alexander Mitchell', 'alex.mitchell@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'ADMIN'),
(2, 'Victoria Sterling', 'victoria@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'ADMIN'),
(3, 'John Smith', 'john@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'CUSTOMER'),
(4, 'Sarah Williams', 'sarah@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'CUSTOMER'),
(5, 'Michael Brown', 'michael@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'CUSTOMER');
...
(1,  'Men',    'men',    'Premium men''s fashion featuring tailored suits, casual wear, accessories, and footwear from world-class designers.',   NULL, '/assets/placeholders/men.jpg',    42),
(2,  'Women',  'women',  'Curated women''s luxury collection from haute couture dresses to timeless accessories and exclusive designer pieces.', NULL, '/assets/placeholders/women.jpg',  38),
(3,  'Fashion','fashion','Trendsetting streetwear and contemporary fashion blends from avant-garde designers and luxury labels.',               NULL, '/assets/placeholders/fashion.jpg',35),
(4,  'Shoes',  'shoes',  'Exquisite footwear collection from Italian leather loafers to limited-edition sneakers and elegant heels.',          NULL, '/assets/placeholders/shoes.jpg',  28),
(5,  'Watches','watches','Haute horlogerie timepieces from Swiss masters including Rolex, Patek Philippe, Audemars Piguet and more.',            NULL, '/assets/placeholders/watches.jpg',22),
(6,  'Bags',   'bags',   'Luxury handbags and accessories from Hermès, Louis Vuitton, Chanel and other iconic fashion houses.',               NULL, '/assets/placeholders/bags.jpg',   26),
(7,  'Perfumes','perfumes','Artisan-crafted fragrances from renowned perfumers featuring rare ingredients and exquisite blends.',               NULL, '/assets/placeholders/perfumes.jpg',20),
(8,  'Beauty', 'beauty', 'Premium beauty and skincare essentials from La Mer, Sisley, and other luxury cosmetic houses.',                      NULL, '/assets/placeholders/beauty.jpg', 18),
(9,  'Makeup', 'makeup', 'Professional-grade makeup collections from Tom Ford, Charlotte Tilbury, and Dior Beauty.',                            NULL, '/assets/placeholders/makeup.jpg', 15),
(10, 'Skincare','skincare','Advanced clinical skincare featuring serums, moisturizers, and treatments from La Prairie and Dr. Barbara Sturm.', NULL, '/assets/placeholders/skincare.jpg',16),
(11, 'Jewelry','jewelry','Fine jewelry collections from Cartier, Tiffany & Co., Van Cleef & Arpels with diamonds and precious gemstones.',      NULL, '/assets/placeholders/jewelry.jpg',24),
(12, 'Sports', 'sports', 'Premium sportswear and equipment from Nike, Adidas, and performance luxury brands.',                                 NULL, '/assets/placeholders/sports.jpg', 14),
(13, 'Electronics','electronics','Cutting-edge luxury electronics from Bang & Olufsen, Apple, and high-end audio brands.',                    NULL, '/assets/placeholders/electronics.jpg',12),
(14, 'Travel Accessories','travel-accessories','Refined travel essentials from Rimowa, Tumi, and Bric''s for the discerning global traveler.', NULL, '/assets/placeholders/travel.jpg',10);
...
-- SETTINGS
-- ============================================================
INSERT IGNORE INTO settings (id, site_name, tagline, currency, tax_rate, free_shipping_threshold, standard_shipping_cost, express_shipping_cost, credit_card, paypal, bank_transfer, crypto) VALUES
(1, 'AddexStores', 'Premium Luxury Ecommerce', 'INR', '8.5', 150.00, 12.99, 24.99, TRUE, TRUE, FALSE, FALSE);
