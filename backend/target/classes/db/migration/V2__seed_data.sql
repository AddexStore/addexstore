...
-- ============================================================
-- Note: icon column omitted here (VARCHAR(255) at this point).
-- Icons are seeded separately in V6 after ALTER to TEXT.
...
-- SUB-CATEGORIES
-- ============================================================
INSERT INTO sub_categories (id, name, slug, product_count, category_id) VALUES
...
-- ============================================================
INSERT INTO products (id, name, slug, description, brand, sku, price, original_price, discount_percentage, stock, rating, total_reviews, featured, trending, is_new_arrival, is_on_sale, sale_end_date, category_id, sub_category_id) VALUES
...
-- PRODUCT VARIANTS
-- ============================================================
INSERT INTO product_variants (id, product_id, size, color, stock, price_override, sku) VALUES
...
-- BANNERS
-- ============================================================
INSERT INTO banners (id, title, subtitle, cta, cta_link, bg_color, image, sort_order, active) VALUES
