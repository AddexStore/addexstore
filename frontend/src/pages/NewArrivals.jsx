...
export default function NewArrivals() {
  ...
  useEffect(() => {
    setLoading(true)
    productService.getProducts({ page: currentPage, size: ITEMS_PER_PAGE, sort: sortBy, newArrival: true })
      .then((data) => {
          ...
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <nav className="flex items-center gap-2 text-sm text-[var(--text-secondary)]">
                ...
                <span className="text-[var(--text-primary)] font-medium">New Arrivals</span>
              </nav>
            </div>
